...
public enum VorbisCommentFieldKey {
    ...
    ALBUM_ARTIST("ALBUM ARTIST", EnumSet.of(Tagger.FOOBAR2000)),
    ...
    TOTALDISCS("TOTALDISCS", EnumSet.of(Tagger.FOOBAR2000)),
    ...
    TOTALTRACKS("TOTALTRACKS", EnumSet.of(Tagger.FOOBAR2000)),
