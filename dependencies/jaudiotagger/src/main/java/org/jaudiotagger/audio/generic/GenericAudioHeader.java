...
public class GenericAudioHeader implements AudioHeader {
    ...
    public GenericAudioHeader() {
        ...
        content.put(FIELD_LENGTH, (double) -1);
    ...
    public double getPreciseLength() {
        return (Double) content.get(FIELD_LENGTH);
    }
    ...
    public void setLength(int length) {
        content.put(FIELD_LENGTH, (double) length);
    }
     ...
     */
    public void setPreciseLength(double seconds) {
