...
public class Defines {
    ...
    // or-values for "flags"
    static int INPUT_SAMPLES = 65536;
    ...
    static short CUR_STREAM_VERS = 0x405; // stream version we are writing now
    ...
    static int IGNORED_FLAGS = 0x18000000; // reserved, but ignore if encountered
    ...
    static int NEW_SHAPING = 0x20000000; // use IIR filter for negative shaping
    ...
    static int SOFT_ERROR = 1;
    static int SRATE_LSB = 23;
    static int TRUE = 1;
    static int UNKNOWN_FLAGS = 0x80000000; // also reserved, but refuse decode if
    static int WAVPACK_HEADER_SIZE = 32;
