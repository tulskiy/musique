...
public class BitStream {
	...
	protected int readCache(boolean peek) throws AACException {
		...
		if(pos>buffer.length-WORD_BYTES) {
            // Denis Tulskiy: ok, this is a hack, I don't know why
            // this exception occurs here, but returning zero doesn't
            // seem to harm the data. Need to consult original author
            return 0;
